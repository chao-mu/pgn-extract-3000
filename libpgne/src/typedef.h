...
typedef struct {
  ...
  bool suppress_originals;
  /* Whether to use fuzzy matching for duplicates. */
  bool fuzzy_match_duplicates;
   ...
   */
  bool lichess_comment_fix;
  /* Only match games with at least one comment. */
  bool keep_only_commented_games;
